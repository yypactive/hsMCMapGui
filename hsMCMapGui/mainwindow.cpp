...
void MainWindow::on_buttonBox_accepted()
{
    ...
    QString strY = QString("%1").arg(mYCoordinate);
    //arg << "D:\\projects\\mc-map\\testFile\\testWorld\\region";
    arg << inputInfo->absoluteFilePath() << outputInfo->absoluteFilePath() << strY << "+RTS" << strthread;
    qDebug()<<arg;
